 ...
 * @author duende
 */
public class PantallaEliminarProveedor extends javax.swing.JInternalFrame {

    /** Creates new form PantallaModProveedor */
    public PantallaEliminarProveedor() {
        initComponents();
    }
    ...
    public boolean FormatearPantalla(Proveedor Proveedor, String Accion, String msj){
            boolean ok = false;
            this.setJlNombreProveedor(Proveedor.getNombre());
            this.setJlCuitProveedor(Proveedor.getCUIT());
            this.setJlDireccionProveedor(Proveedor.getDireccion());
            this.setJlEmailProveedor(Proveedor.getEmail());
            this.setJlTelProveedor(Proveedor.getTelefono());            
            this.setTitle(Accion);            
            this.setJlMensaje(msj);           
            ok = true;
            return ok;
    }
